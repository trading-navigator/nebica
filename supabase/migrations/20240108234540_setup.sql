...
AS $$
DECLARE
  project_url TEXT := 'https://horypmzlkpadzitlwrea.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhvcnlwbXpsa3BhZHppdGx3cmVhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MDM0NTI0MywiZXhwIjoyMDY1OTIxMjQzfQ.DI3ZsDltojxRp2wTenQC_7cTMjbmWEyp9UOaKz0-_ZU'; -- full access needed for http request to storage
